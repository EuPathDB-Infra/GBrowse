package Bio::Graphics::Browser2::OracleSessionDriver;
...
@Bio::Graphics::Browser2::OracleSessionDriver::ISA       = qw( CGI::Session::Driver::DBI );
$Bio::Graphics::Browser2::OracleSessionDriver::VERSION   = '1.05';
...
sub _run_sql
{
	...
	#print STDERR "Using custom Oracle driver to write session for $sid\n";
	eval
	{
		...
		# This causes errors. :(
		#$sth->bind_param(1, $datastr, { ora_type => ORA_CLOB }) or return 0;
